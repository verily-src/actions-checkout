...
export interface IGitCommandManager {
  ...
  submoduleUpdateSpecific(fetchDepth: number, recursive: boolean, submoduleNames: string[]): Promise<void>
...
class GitCommandManager {
  ...
  async submoduleUpdateSpecific(
    fetchDepth: number,
    recursive: boolean,
    submoduleNames: string[]): Promise<void> {
